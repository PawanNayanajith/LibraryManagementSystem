                        ...
                        <tbody id="myTable">
                            ...
                            <%
                                try {
                                    ...
                                    String sql = "select * from subclassification order by subClass";
                                    resultSet = statement.executeQuery(sql);
                                    while (resultSet.next()) {
                            %>
                            <tr>
                                <td><%=resultSet.getString("subClass")%></td>
                                <td><a href="updateClassificationSubAction.jsp?id=<%=resultSet.getString("subID")%>"><button type="button" class="btn btn-success">Update</button></a></td>
                            </tr>
                            <%
                                    }
                                    connection.close();
