...
<html>
    ...
    <div class="container" align="center">
        ...
        <form class="form-style-9" action="Classification" method="get">
            <ul>
                <li>
                    <input type="text" name="mainClass" class="field-style" placeholder="Add Main Classification" />
                 </li>
                <br>

                <li>
                    <input type="reset" value="Reset" class="field-style"/>
                    <input type="submit" name="submit" value="Add Classification" class="field-style" />
                </li>
                <br/>
