...
<html>
    <head>
        ...
        <title>Search Sub Classification</title>       
    </head>
    <div class="container" align="center">
        ...
        <form class="form-style-9" action="SearchClassificationSub" method="post">
            <ul>
                <li>
                    <h4 class="text-center">Search Sub Classifications</h4>
                ...
                <li>
                    <a href="viewAllClassification.jsp">
                        <input type="button" name="View" value="View All Classifications" /></a>
                </li> 
            </ul>
        </form>
