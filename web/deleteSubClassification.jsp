...
<html>
    <head>
        ...
        <title>Delete Sub Classification</title>       
    </head>
            ...
            <table class="table table-bordred table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td><a href="deleteSubClassificationProcess.jsp?id=<%=resultSet.getString("subID")%>"><button type="button" class="btn btn-danger">Delete</button></a></td>
                    </tr>
                    <%
                            }
                            connection.close();
