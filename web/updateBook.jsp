...
<html>
    <head>
        ...
        <title>Update Classification</title>       
    </head>
                    ...
                    <table class="table table-bordred table-striped">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td><a href="updateBookAction.jsp?id=<%=resultSet.getString("bookID")%>"><button type="button" class="btn btn-success">Update</button></a></td>
                            </tr>
                            <%
                                    }
                                    connection.close();
