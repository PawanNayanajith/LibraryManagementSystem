...
<html>
    <head>
        ...
        <title>Update Sub Classifications</title>       
    </head>
    <div class="container" align="center">
        ...
        <%
            try {
                ...
                String sql = "select * from subclassification where subID=\"" + id + "\"";
        ...
        <html>
            <body>
                <h3>Update the Sub Classification Details</h3>
                <form class="form-style-9" action="updateClassificationSubProcess.jsp" method="post">
                    <input type="hidden" name="id" value="<%=resultSet.getString("subID")%>">

                    <ul>
                        <li>
                            <input type="text" name="subClass" class="field-style" value="<%=resultSet.getString("subClass")%>" placeholder='Sub Classification'/>
                        </li>
                        <br>
                        ...
                        <li>
                            <input type="submit" name="submit" value="Update Sub Classification" class="field-style" />
                        </li>
                        <br/>
                    </ul>
                </form>
