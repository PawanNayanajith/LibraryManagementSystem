...
<html>
    ...
    <div class="container" align="center">
        ...
        <form class="form-style-9" action="ClassificationSub" method="get">
            <ul>
                <li>
                    <input type="text" name="mainClass" class="field-style" placeholder="Main Classification" />
                </li>
                <li>
                    <input type="text" name="subClass" class="field-style" placeholder="Add Sub Classification" />
                </li>

                <br>

                <li>
                    <input type="reset" value="Reset" class="field-style"/>
                    <input type="submit" name="submit" value="Add Sub Classification" class="field-style" />
                </li>
                <br/>
